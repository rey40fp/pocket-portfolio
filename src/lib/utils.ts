 ...
 *
 * @example
 *   formatRelativeTime(new Date(Date.now() - 30_000))    // "just now"
 *   formatRelativeTime(new Date(Date.now() - 120_000))   // "2 minutes ago"
 *   formatRelativeTime(new Date(Date.now() - 7200_000))  // "2 hours ago"
 *   formatRelativeTime(new Date(Date.now() - 90000_000)) // "1 day ago"
 */
